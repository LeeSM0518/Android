...
public class BasicInfo {
    ...
    // 메모 아이템 분류 상수
    public static final int MEMO_TITLE = 0;
    public static final int MEMO_DATE = 1;
    public static final int MEMO_TEXT = 2;
    public static final int MEMO_ID_HANDWRITING = 3;
    public static final int MEMO_URI_HANDWRITING = 4;
    public static final int MEMO_ID_PHOTO = 5;
    public static final int MEMO_URI_PHOTO = 6;
    public static final int MEMO_ID_VIDEO = 7;
    public static final int MEMO_URI_VIDEO = 8;
    public static final int MEMO_ID_VOICE = 9;
    public static final int MEMO_URI_VOICE = 10;
    ...
    public static SimpleDateFormat dateDayNameFormat = new SimpleDateFormat("yyyy년 MM일 dd일");
    @SuppressLint("SimpleDateFormat")
    ...
    public static boolean isAbsoluteVideoPath(String videoUri) {
        if (videoUri.startsWith(URI_MEDIA_FORMAT)) return false;
        else return true;
    }
}
